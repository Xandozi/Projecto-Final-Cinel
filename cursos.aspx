    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid">
                <div id="filterForm" runat="server" class="border-dark" style="display: none; margin-bottom: 10px; margin-top: 10px; border: 1px solid #ccc; background-color:antiquewhite; padding: 10px;">
                    <div class="row">
                        <div class="col-md-2">
