<%@ Page Title="CINEL - Cursos" Language="C#" MasterPageFile="~/Cinel.Master" AutoEventWireup="true" CodeBehind="cursos.aspx.cs" Inherits="Projeto_Final.cursos" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <div class="container-fluid">
                <div id="filterForm" runat="server" class="border-dark bg-secondary" style="display: none; margin-bottom: 10px; margin-top: 10px; border: 1px solid #ccc; color:black; padding: 10px;">
                    <div class="row">
                        <div class="col-md-2">
                ...
                <div class="row" style="margin-top: 30px; margin-bottom: 100px;">
                    ...
                    <div class="col-md-2 bg-light" style="margin-bottom: 10px;">
                        <div class="list-group">
                            <a href="cursos.aspx" class="list-group-item list-group-item-action active"><i class="fas fa-chalkboard"></i> Cursos</a>
