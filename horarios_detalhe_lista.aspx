<%@ Page Title="" Language="C#" MasterPageFile="~/Cinel.Master" AutoEventWireup="true" CodeBehind="horarios_detalhe_lista.aspx.cs" Inherits="Projeto_Final.horarios_detalhe_lista" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid">
        ...
        <div class="row justify-content-between" style="margin: 10px;">
            ...
            <a href="horarios_lista.aspx" class="btn btn-info">Voltar para a página Horários</a>
        </div>
    </div>
