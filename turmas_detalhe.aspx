                ...
                <div class="card" style="border-color: #333;">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-5">
                                <div class="row" style="margin-left: 2px;">
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        ...
                                        <div class="row">
                                            <asp:ListBox ID="lstb_formadores_modulos" runat="server" Style="width: 90%;"></asp:ListBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row" style="margin-left: 2px;">
                                    <div class="col-md-12" style="margin-top: 20px;">
                                        ...
                                        <div class="row">
                                            <asp:ListBox ID="lstb_formandos" runat="server" Style="width: 90%;"></asp:ListBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-flex justify-content-lg-between mt-3">
                            <asp:Button ID="btn_editar" class="btn btn-primary btn-lg" runat="server" Text="Editar Turma" CausesValidation="false" OnClick="btn_editar_Click" />
                        </div>
                    </div>
                </div>
            </div>
