<%@ Page Title="CINEL - Horários" Language="C#" MasterPageFile="~/Cinel.Master" AutoEventWireup="true" CodeBehind="horarios.aspx.cs" Inherits="Projeto_Final.horarios" %>
                ...
                <div class="row" style="margin-top: 30px; margin-bottom: 100px;">
                    ...
                    <div class="col-md-2 bg-light" style="margin-top: 10px;">
                        <div class="list-group">
                            <a href="#" class="list-group-item list-group-item-action active"><i class="fas fa-calendar"></i> Horários</a>
                    ...
                    <div class="col-md-10">
                        <div id="card_horarios" class="card bg-secondary" style="border-color: #333; color:black; margin-top: 10px;" runat="server">
