<%@ Page Title="CINEL - Formadores" Language="C#" MasterPageFile="~/Cinel.Master" AutoEventWireup="true" CodeBehind="formadores.aspx.cs" Inherits="Projeto_Final.formadores" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="tb_nome_formador" CssClass="form-control" runat="server" Style="margin-left: 5px;" TextMode="SingleLine" placeholder="Nome Formador..."></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                ...
                <div class="row" style="margin-top: 30px; margin-bottom: 100px;">
                    ...
                    <div class="col-md-2 bg-light" style="margin-bottom: 10px;">
                        <div class="list-group">
                            <a href="formadores.aspx" class="list-group-item list-group-item-action active"><i class="fas fa-user-graduate"></i> Formadores</a>
                    ...
                    <div class="col-md-10">
                        <div class="card bg-secondary" style="border-color: #333; color:black;">
                            <div class="card-header bg-dark text-white">
                                <h2 class="display-4 text-center" style="font-size: 30px; color: white;">Consulta de Formadores</h2>
                            </div>
                                                ...
                                                <div class="card  border-dark" style="margin: 5px;">
                                                    <a href="utilizadores_detalhe.aspx?cod_user=<%# Eval("cod_user") %>" style="text-decoration: none;">
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text" style="color: black;">Módulo: <span style="color: orangered"><%# Eval("cod_ufcd") %> | <%# Eval("nome_modulo") %></span></p>
                                                        </div>
                                                    </a>
                                                </div>
                                            </div>
