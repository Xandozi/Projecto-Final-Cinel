<%@ Page Title="CINEL - Detalhes do Módulo" Language="C#" MasterPageFile="~/Cinel.Master" AutoEventWireup="true" CodeBehind="modulos_detalhe.aspx.cs" Inherits="Projeto_Final.modulos_detalhe" %>
                ...
                <div class="row" style="margin-top: 30px;">
                    ...
                    <div class="col-md-3 bg-light" style="margin-bottom: 10px;">
                        <div class="list-group">
                            <a href="#" class="list-group-item list-group-item-action active"><i class="fas fa-table"></i> Módulo <%= lbl_cod_ufcd.Text %> - <%= lbl_nome_modulo.Text %></a>
                    ...
                    <div class="col-md-9 col-lg-5 col-xl-4">
                        <div class="card bg-secondary" style="border-color: #333; color:black;">
                            <div class="card-header bg-dark text-white">
                                <h2 class="display-4" style="font-size: 30px; color: white;">Módulo <%= lbl_cod_ufcd.Text %></h2>
                            </div>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
