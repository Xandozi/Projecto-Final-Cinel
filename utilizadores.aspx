<%@ Page Title="CINEL - Utilizadores" Language="C#" MasterPageFile="~/Cinel.Master" AutoEventWireup="true" CodeBehind="utilizadores.aspx.cs" Inherits="Projeto_Final.utilizadores" %>
                ...
                <div class="row" style="margin-top: 30px; margin-bottom: 100px;">
                    ...
                    <div class="col-md-2 bg-light" style="margin-bottom: 10px;">
                        <div class="list-group">
                            <a href="utilizadores.aspx" class="list-group-item list-group-item-action active"><i class="fas fa-user"></i> Utilizadores</a>
